...
export type QueryMediaCollectionQueryVariables = Exact<{
  page?: InputMaybe<Scalars['Int']['input']>;
  perPage?: InputMaybe<Scalars['Int']['input']>;
  where_media_id?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>> | InputMaybe<Scalars['Int']['input']>>;
}>;
...
export type QueryMediaCollectionQuery = { __typename?: 'Query', Page?: { __typename?: 'Page', media?: Array<{ __typename?: 'Media', id: number, bannerImage?: string | null, coverImage?: { __typename?: 'MediaCoverImage', large?: string | null, medium?: string | null } | null } | null> | null } | null };
...
/**
 * __useQueryMediaPageQuery__
 *
 * To run a query within a React component, call `useQueryMediaPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useQueryMediaPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useQueryMediaPageQuery(baseOptions?: Apollo.QueryHookOptions<QueryMediaPageQuery, QueryMediaPageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<QueryMediaPageQuery, QueryMediaPageQueryVariables>(QueryMediaPageDocument, options);
      }
export function useQueryMediaPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<QueryMediaPageQuery, QueryMediaPageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<QueryMediaPageQuery, QueryMediaPageQueryVariables>(QueryMediaPageDocument, options);
        }
...
export const QueryMediaCollectionDocument = gql`
...
/**
 * __useQueryMediaCollectionQuery__
 *
 * To run a query within a React component, call `useQueryMediaCollectionQuery` and pass it any options that fit your needs.
 * When your component renders, `useQueryMediaCollectionQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useQueryMediaCollectionQuery(baseOptions?: Apollo.QueryHookOptions<QueryMediaCollectionQuery, QueryMediaCollectionQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<QueryMediaCollectionQuery, QueryMediaCollectionQueryVariables>(QueryMediaCollectionDocument, options);
      }
export function useQueryMediaCollectionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<QueryMediaCollectionQuery, QueryMediaCollectionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<QueryMediaCollectionQuery, QueryMediaCollectionQueryVariables>(QueryMediaCollectionDocument, options);
        }
export type QueryMediaCollectionQueryHookResult = ReturnType<typeof useQueryMediaCollectionQuery>;
export type QueryMediaCollectionLazyQueryHookResult = ReturnType<typeof useQueryMediaCollectionLazyQuery>;
export type QueryMediaCollectionQueryResult = Apollo.QueryResult<QueryMediaCollectionQuery, QueryMediaCollectionQueryVariables>;
